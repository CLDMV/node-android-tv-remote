...
async function debugKeyboardCreation() {
	...
	console.log(
		"Special characters:",
		Object.keys(keyboardKeys).filter((key) => !key.match(/^[a-z0-9]$/))
	);
	...
	console.log(
		...
		allKeyboardKeys.filter((key) => typeof remote.keyboard.key[key] !== "function" && typeof remote.keyboard.key[key] !== "object").length
	);
