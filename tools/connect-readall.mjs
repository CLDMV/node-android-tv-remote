 ...
 *	@Filename: /tools/connect-readall.mjs
...
// Usage: node tools/connect-readall.mjs <ip> [port] [get|set] [--quiet]
...
Usage: node tools/connect-readall.mjs <ip> [port] [mode] [options]
...
Examples:
  node tools/connect-readall.mjs 192.168.1.100
  node tools/connect-readall.mjs 192.168.1.100 5555 set
  node tools/connect-readall.mjs 192.168.1.100 5555 get --quiet
		`);
		process.exit(0);
	}
	...
	if (args.length === 0 || !args[0] || args[0].startsWith("--")) {
		...
		console.error("Usage: node tools/connect-readall.mjs <ip> [port] [get|set] [--quiet]");
